...
**Seeded world 4 complete diagnostic — September 23, 12:52:45 CST:** **10/10 B30 episodes and both resource groups closed**. Native1, NoGraphRisk and ExplicitRepeatRisk have identical actions and zero scores in each seed. Equal-two Internal2 minus Common2 has paired score differences +0.125/0 (mean +0.0625, sample variance 0.0078125, SD 0.08838835) and failure differences +1/−17 (mean −8, sample variance 162, SD 12.727922). All 10 task-success flags are false. These are n=2 sampling-seed summaries in one world; robust benefit, cross-world generalization and original Full completion are not established. [All outcomes, exact statistics, costs and prefix validation](../results/discoveryworld/diagnostics/20260923T125245_CST/README.md). Historical unseeded p335 is not pooled; earlier dated results are preserved.

**P336 NoGraph revision diagnostic — September 23, 12:36:32 CST:** all 28 ExplicitRepeatRisk alternatives hit the layer-12 transcoder fidelity gate, so no supported risk comparison occurred. NoGraphRisk had 6 gated alternatives and 22 supported comparisons that assigned higher risk to the alternative and kept candidate 0. All 56 alternatives parsed; JSON structure differences do not establish different action semantics or successful counterfactuals. [Actual decisions, exact audit source and limits](../results/discoveryworld/diagnostics/20260923T123632_CST/report.md). This explains only these NoGraph runs; original full-graph behavior and any revised method still require their own evaluation.

**Seeded world 4 partial progress — September 23, 12:28:47 CST:** **9/10 B30 episodes closed**; seed 336 Internal2 has 6/30 actions and no final metric. In each of seeds 336/337, NoGraphRisk and ExplicitRepeatRisk match all 30 Native1 actions and its zero score. Seed 336 Common2 scores 0.125, without establishing an NN contribution. Seed 337 Internal2 has 17 fewer failures than Common2 but 2 more than Native1; all three scores are 0. The complete-results gate remains `publication_ready=false`; no two-seed aggregate or original Full result is claimed. [All ten slots, paired limits and validation](../results/discoveryworld/progress/20260923T122847_CST/README.md). Earlier dated evidence remains intact.
...
The [read-only DiscoveryWorld closed-action audit at September 22, 18:47 CST](../results/discoveryworld/diagnostics/20260922T184705_CST/report.md) reuses twenty actions from Q75/p304 and Common2/p305. Q75 made three identical second proposals; two candidate-rank changes produced zero executed-action changes. Common2's nine successful actions had no immediate score gain. Risk metrics and retrospective 0.5 alarms are recomputed portably; the actual controller threshold was not changed. These different-seed episodes are not a paired treatment comparison, and no new trajectory or fit is counted.

The [DiscoveryWorld development snapshot at September 22, 18:33 CST](../results/discoveryworld/development/20260922T183307_CST/report.md) adds two closed conditions: Q75/p304, 10 failed actions and score 0; Common2/p305, 1 failed action and score 0. Their within-seed partners are incomplete, so these are not an effect comparison. CV-v1 did not fit because one training fold contained only 7 negative rows. Prospective early-prefix supplementation has label-only support, with 0 extra graphs extracted. Earlier snapshots remain unchanged.

The [DiscoveryWorld CPU diagnostics through September22 17:22 CST](../results/discoveryworld/diagnostics/20260922T172256_CST/report.md) contain four completed feature-family fits, a separate8-model/16-NN-state training diagnosis, reproduction controls, and a fixed0.5 cached-prediction comparison. All families and limitations are retained: GraphOnly AUROC0.9133, OutputAction/NoGraph0.9600, Internal0.9700, on40 steps within2 episodes in1 world. Later training reduces fit NLL while increasing Internal development probability loss; the frozen200-step production model is not replaced. This is development evidence, not an online or held-out Full-method improvement.
