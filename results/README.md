...
The [independent9B training-collection acceptance](qwen35_9b_core/collections/20260920T231045_CST/report.md) verifies **two of seven** registered collections: Al-Au-Hf seeds1/2, B50. It rechecks100 already executed candidate evaluations,336 proposals and all32 activation layers per collection with the original CPU auditor. These are training data, **not additions to the15 baseline tests**; no model, graph, oracle or fitting work was added, and full9B method efficacy is not claimed.
