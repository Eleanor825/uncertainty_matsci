...
def main():
    ...
    summary={'schema':'MADE_all60_core_trace_mechanism_analysis_v1','input':{'path':'inputs/trajectories.jsonl.gz','sha256':DATA_SHA},'original_summary_sha256':SUMMARY_SHA,
        ...
        'new_fits':0,'new_LLM_graph_oracle_calls':0,'public_push':True}
